          ...
          <div className="leftSide">
            <div className="stats">
              ...
              <div className="stakeholders">
                <Stat img={corporates} count={stat?.corporates} title={"Corporates"} />
                <Stat img={NGOs} count={stat?.ngos} title={"NGOs"} />
                <Stat img={institutes} count={stat?.educationalInstitutions} title={"Institutes"} />
                <Stat img={citizens} count={stat?.workingProfessional} title={"Citizens"} />
              </div>
            </div>
