...
const UserInfoCard = ({ userId, name, stakeholder}) => {
  ...
  return (
    <div className="userInfoCard">
      <div className="cardContainer">
        <MiniCollabProfile name={name} stakeholder={stakeholder} />
      ...
      <div className="buttons">
        <button onClick={() => navigate("/admin/useractivity/details", { state: {userId: userId } })}>
          View Details
        </button>
